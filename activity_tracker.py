...
def track_activity():
    ...
    working_on_textbox = ctk.CTkTextbox(tabview.tab("Working On"), width=300, height=100)
    ...
    notes_textbox = ctk.CTkTextbox(tabview.tab("Notes"), width=300, height=100)
    ...
    todos_textbox = ctk.CTkTextbox(tabview.tab("Todos"), width=300, height=100)
